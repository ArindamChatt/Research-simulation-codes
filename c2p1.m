...
% Case 2: 128 Users – 50 Gbps
Bm_values = [400, 600, 800];
LR = 50 * 1e3;                 % Line rate = 50 Gbps
PT = 0.9;                      % ask ma’am about this
PON = 1;
max_split_ratio = 128;         % 128 users
...
title('Number of Users vs Violation of Promised Availability (128 Users – 50 Gbps)');
